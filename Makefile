C_SOURCES = $(wildcard kernel/*.c drivers/*.c cpu/*.c libc/*.c mmu/*.c)
HEADERS = $(wildcard kernel/*.h drivers/*.h cpu/*.h libc/*.h mmu/*.h)
...
clean:
	...
	rm -rf kernel/*.o boot/*.bin drivers/*.o boot/*.o cpu/*.o libc/*.o mmu/*.o
